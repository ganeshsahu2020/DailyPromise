...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "inline-flex w-full items-center justify-between rounded-md border border-white/20",
      "bg-slate-800 px-3 py-2 text-sm text-white shadow-sm",
      "ring-offset-slate-950 placeholder-white/60",
